...
<body>
    <div class="container">
        <h2>Edit Course</h2>
        <form action="{{ route('courses.update', ['student' => $student->id, 'course' => $course->id]) }}" method="POST">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="section" name="section" value="{{ $course->section }}" required>
            </div>
            <div class="form-group">
                <label for="course_status">حالة المادة</label>
                <input type="text" class="form-control" id="course_status" name="course_status" value="{{ $course->course_status }}" required>
            </div>
            <div class="form-group">
                <label for="marks">العلامة الفصلية</label>
                <input type="text" class="form-control" id="marks" name="marks" value="{{ $course->marks }}" required>
            </div>
            <div class="form-group">
                <label for="final_mark"> العلامة النهائية</label>
                <input type="text" class="form-control" id="final_mark" name="final_mark" value="{{ $course->final_mark }}" required>
            </div>
            <div class="form-group">
                <label for="hours_number">عدد الساعات</label>
                <input type="text" class="form-control" id="hours_number" name="hours_number" value="{{ $course->hours_number }}" required>
            </div>
